...
export function StartupListPage(props: StartupListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStartups({
        relations: ['user', 'trade_order.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('trade_order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'trade_order',
          header: 'Trade Order',
          accessorKey: 'trade_order',
          cell: ({ row: { original: record } }: any) => record?._count?.trade_order,
        }
      : null,
